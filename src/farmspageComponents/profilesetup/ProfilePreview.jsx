...
function ProfilePreview({ requiredProps, onPrevious, uploadedFiles }) {
  ...
  return (
    <div className="px-14">
      ...
      {requiredProps && requiredProps.length > 0 ? (
          ...
          <div key={index} className="">
            <ul className="list-none flex gap-4 items-end mb-7">
              ...
              <li className="flex flex-col">
                <p className="text-primary font-semibold leading-6">
                  {capitalizeFirstLetter(prop.farmName)}
                </p>
                <p className="text-sm font-medium leading-3">
                  {capitalizeFirstLetter(prop.farmLocation)}
                </p>
            ...
            <div className="text-sm mb-6">
              <p className="text-primary font-semibold ">
                Top Produce by {capitalizeFirstLetter(prop.farmName)}
              </p>
              <p className="font-medium pt-1 pb-3">
                {capitalizeFirstLetter(prop.products)}
              </p>
            ...
            <div className="text-sm mb-6">
              ...
              <p className="pb-2">{capitalizeFirstLetter(prop.aboutUs)}</p>
            ...
            {!showMore ? (
              <span className="text-primary border border-primary w-[28rem] flex items-center gap-2 py-1 px-2 rounded-2xl text-xs mb-6">
                <TbTruckDelivery size={20} /> Delivery within Lagos takes 2-3
                hours. Inter-state delivery takes 5-7 hours.
              </span>
            ) : (
              ""
            )}
              ...
              <div className="">
                <div className="grid text-sm grid-cols-1 md:grid-cols-2 gap-y-3 ">
                  ...
                  <div className="">
                    ...
                    <span className="">
                      {capitalizeFirstLetter(prop.farmSize)}
                    </span>
                  </div>
                  ...
                  <div className="">
                    ...
                    <span className="">
                      {capitalizeFirstLetter(prop.farmMethod)}
                    </span>
                  </div>
                  ...
                  <div className="">
                    ...
                    <span className="">
                      {capitalizeFirstLetter(prop.yearsOfExperience)}
                    </span>
                  </div>
                  ...
                  <div className="">
                    ...
                    <span className="">
                      {capitalizeFirstLetter(prop.businessHours)}
                    </span>
                  </div>
                  ...
                  <div className="">
                    ...
                    <ul className="list-none">
                      <li className="flex gap-2 items-center">
                        ...
                        <span
                          className="text-primary flex gap-1 items-center cursor-pointer border-b border-b-primary leading-3"
                          onClick={() =>
                            setViewedFile(uploadedFiles.certificate)
                          }
                        >
                      ...
                      <li className="flex gap-2 items-center">
                        Land C of O
                        <span
                          className="text-primary flex items-center cursor-pointer gap-1 border-b border-b-primary leading-3"
                          onClick={() => setViewedFile(uploadedFiles.document)}
                        >
                      ...
                      <li className="flex gap-2 items-center">
                        ...
                        <span
                          className="text-primary flex gap-1 items-center cursor-pointer border-b border-b-primary leading-3"
                          onClick={() => setViewedFile(uploadedFiles.id)}
                        >
                    ...
                    {viewedFile && (
                      ...
                      <div className="bg-white p-4  flex flex-col items-center justify-center rounded-md">
                      <span className="flex justify-end w-full mb-2">
                        <button
                          className="text-primary mt-2 text-lg font-semibold underline"
                        ...
                        <img
                          src={viewedFile}
                          alt="Preview"
                          className="max-w-full w-[30rem] h-[20rem] max-h-screen"
                        />
                  ...
                  <div className="text-sm">
                    ...
                    <span className="uppercase">
                      {capitalizeFirstLetter(prop.paymentMethod)}
                    </span>
                  </div>
                </div>
...
ProfilePreview.propTypes = {
  requiredProps: PropTypes.arrayOf(PropTypes.object).isRequired,
